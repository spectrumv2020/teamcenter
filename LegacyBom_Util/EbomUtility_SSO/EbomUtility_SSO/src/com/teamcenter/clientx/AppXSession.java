...
public class AppXSession
{
     ...
     *
     */
    public User loginUsingArguments(String sUsername, String sPassword)
    {
        // Get the service stub
        SessionService sessionService = SessionService.getService(connection);
    ...
    public User ssoLogin(String ssoServerhost, String ssoAppID)
    {
    	// Get the service stub
        SessionService sessionService = SessionService.getService(connection);
        SsoCredentials ssoCredentials = new SsoCredentials(ssoServerhost, ssoAppID);
        
           if(ssoCredentials != null && connection != null)
           {
                   try 
                   {
                	   connection.setCredentialManager(ssoCredentials);
