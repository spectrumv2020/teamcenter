...
public class SSO_Test_Login 
{
        ...
        public static void main_Login(String[] args) {
			try {
				...
				System.out.println("TC Host :" + args[0]);
				System.out.println("SSO Server Host :" + args[1]);
				System.out.println("SSO App ID :" + args[2]);
				SSO_Test_Login ssoTestLogin = new SSO_Test_Login(args[0], args[1], args[2]);
				
				if(ssoTestLogin.ssoLogin())
				{
					System.out.println("Logged In Successfully....!");
					System.out.println(ssoTestLogin.getUser());
					System.out.println(ssoTestLogin.getConnection());
					ssoTestLogin.logout();
				}
				else
				{
					System.out.println("SSO Login Failed...!");
				}
			}catch(Exception ex){
        ...
        public SSO_Test_Login(String host, String ssoServerhost,String ssoAppID)
        {
