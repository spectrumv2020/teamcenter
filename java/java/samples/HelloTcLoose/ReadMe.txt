...
the Loosely typed client data model vs the strongly typed client data model.
...
2. Import the project
   ...
   Click Next, then browse to .../soa_client/java/samples/HelloTcLoose, select Finish
...
4. Execute the client application
   ...
   Select the HelloTcLoose Java Application 
