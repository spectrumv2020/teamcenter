...
/**
 * Sample implementation of the PartialErrorListener.
 * Print any partial errors returned.
 */
public class TcWebPartialErrorListener implements PartialErrorListener {
    ...
    public void handlePartialError(ErrorStack[] stacks)
    {
        ...
        System.out.println("");
        System.out.println("*****");
        System.out.println("Partial Errors caught in com.teamcenter.clientx.TcWebPartialErrorListener.");
