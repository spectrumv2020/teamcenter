This sample demonstrates creation of a custom Runtime Business Object.
...
template can be found at .../soa_clients/java/samples/RuntimeBO/sampleruntimebo.  Use the Business Modeler IDE 
...
4. Execute the client application
   ...
   Select the RuntimeBO Java Application 
   ...
   or 
   Change the value of "org.eclipse.jdt.launching.VM_ARGUMENTS" in RuntimeBO.launch file .
...
3. Use tccs://<tccs_envname> (TCCS protocol and environment name) as the 
 ...
 The source file RuntimeBO.java has the main function for the application. This is the 
 ...
 basic features of Teamcenter Services.
     ...
     DataManagement          This class creates and sets property values on a runtime business object
