/*HEAD ITEM_REVISION_CREATE_PRE_CONDITION CCC ITK */

extern DLLAPI int item_rev_create_pre_condition(METHOD_message_t *msg, va_list args)
{
    ECHO( "\n item_rev_create_pre_condition \n");
