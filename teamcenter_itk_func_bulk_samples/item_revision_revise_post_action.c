/*HEAD ITEM_REVISION_REVISE_POST_ACTION CCC ITK */

extern DLLAPI int item_rev_revise_post_action(METHOD_message_t *msg, va_list args)
{
    ECHO( "\n item_rev_revise_post_action \n");
