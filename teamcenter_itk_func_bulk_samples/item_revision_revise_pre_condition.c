/*HEAD ITEM_REVISION_REVISE_PRE_CONDITION CCC ITK */

extern DLLAPI int item_rev_revise_pre_condition(METHOD_message_t *msg, va_list args)
{
    ECHO( "\n item_rev_revise_pre_condition \n");
