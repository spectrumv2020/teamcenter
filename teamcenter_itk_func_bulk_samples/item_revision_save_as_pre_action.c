/*HEAD ITEM_REVISION_SAVE_AS_PRE_ACTION CCC ITK */

extern DLLAPI int item_rev_save_as_pre_action(METHOD_message_t *msg, va_list args)
{
    ECHO( "\n item_revision_save_as_pre_action \n");
